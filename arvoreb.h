...
int buscaProximo(Arvb *arv, int item , int esq, int dir); // Retorna a busca da posição de onde se encontra o item
...
void inserir(Arvb *arv,Arvb *pai,int valor); // Inserir um item na Árvore

// Funções de Pesquisa
int buscarItemPag(Arvb *arv, int valor, int inicio, int fim); // Retorna se o item está presente na Página
...
int possui(Arvb *arv,int valor); // Retorna se existe o item na Página
void pesquisa(Arvb *arv,int valor); // Retorna a Árvore(Página) onde se encontra o item
...
int removerItem(Arvb *arv, int valor); // Remove o item da Página
void remover(Arvb *arv, Arvb *pai, int valor); // Remover Página
